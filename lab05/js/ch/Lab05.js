...
function initInterface() {
  ...
  document.getElementById("xsca").addEventListener("input", function (event) {
    if (changePos === 1)
      sx = this.value;
    else if (changePos === 2)
      sx = this.value;
  ...
  document.getElementById("ysca").addEventListener("input", function (event) {
    if (changePos === 1)
      sy = this.value;
    else if (changePos === 2)
      sy = this.value;
  ...
  document.getElementById("zsca").addEventListener("input", function (event) {
    if (changePos === 1)
      sz = this.value;
    else if (changePos === 2)
      sz = this.value;
